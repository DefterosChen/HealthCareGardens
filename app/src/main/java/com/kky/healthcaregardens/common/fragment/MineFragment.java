...
import com.kky.healthcaregardens.common.fragment.device.smartwatch.WatchFragment;
import com.kky.healthcaregardens.common.fragment.home.MessageFragment;
import com.kky.healthcaregardens.common.fragment.mine.AboutFragment;
import com.kky.healthcaregardens.common.fragment.mine.CompanyProfileFragment;
import com.kky.healthcaregardens.common.fragment.mine.HealthRecordFragment;
import com.kky.healthcaregardens.common.fragment.mine.LoginFragment;
import com.kky.healthcaregardens.common.fragment.mine.MyCreditFragment;
import com.kky.healthcaregardens.common.fragment.mine.MyInfoFragment;
import com.kky.healthcaregardens.common.fragment.mine.MyOrderFragment;
import com.kky.healthcaregardens.common.fragment.mine.SettingFragment;
import com.kky.healthcaregardens.common.model.vo.LoginUser;
import com.kky.healthcaregardens.common.model.vo.UserInfo;
    ...
    private void createHandlerManage() {
        handler = new Handler(new Handler.Callback() {
            ...
            private void showData() {
                ...
                stv_myinfo.setLeftString(userInfo.getData().getSysUser().getUsername());
            }
        });
...
//    }
    ...
    private void showInfo() {
        ...
        if (accessToken == null || accessToken.equals("")) {
            System.out.println("m暂未登录,没有获取到显示用户信息所需的token");
            return;
        }

        String url = ServiceCall.getServerURL() + "/admin/user/info";
