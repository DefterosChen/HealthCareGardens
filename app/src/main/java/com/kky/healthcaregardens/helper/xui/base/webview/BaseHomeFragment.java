...
package com.kky.healthcaregardens.helper.xui.base.webview;
...
import com.kky.healthcaregardens.common.activity.TableActivity;
import com.kky.healthcaregardens.common.model.vo.KkyItem;
import com.kky.healthcaregardens.helper.xui.DemoDataProvider;
import com.kky.healthcaregardens.helper.xui.common.adapter.WidgetItemAdapter;
 ...
 */
public abstract class BaseHomeFragment extends BaseFragment implements RecyclerViewHolder.OnItemClickListener<KkyItem> {
...
//        });
    ...
    private void initRecyclerView() {
        ...
        mWidgetItemAdapter = new WidgetItemAdapter(DemoDataProvider.getDeviceNewInfos());
    ...
    @Override
    @SingleClick
    public void onItemClick(View itemView, KkyItem widgetInfo, int pos) {
        if (widgetInfo != null) {
            openNewPage(widgetInfo.getName());
        }
    }

    public TableActivity getContainer() {
        return (TableActivity) getActivity();
    }
